namespace HuniCafe.Migrations
{
    ...
    //        context.SaveChanges();
    //        var coffee = context.Categories.Single(c => c.CategoryName == "Coffee");
    //        var tea = context.Categories.Single(c => c.CategoryName == "Tea");
    //        var cake = context.Categories.Single(c => c.CategoryName == "Cake");
    //        var juice = context.Categories.Single(c => c.CategoryName == "Juice");
    //        context.Products.AddOrUpdate(
    //            p => p.ProductName,
    //            new Product { ProductName = "Cà phê sữa", Description = "Cà phê pha với sữa đặc", Price = 30000, CategoryID = coffee.CategoryID, Image = "https://res.cloudinary.com/dgzvq4bfv/image/upload/v1784874650/Screenshot_2026-07-24_133017_gqtuij.png" },
    //            new Product { ProductName = "Cà phê đen", Description = "cà phê nguyên chất không sữa", Price = 25000, CategoryID = coffee.CategoryID, Image = "https://res.cloudinary.com/dgzvq4bfv/image/upload/v1784874650/Screenshot_2026-07-24_133017_gqtuij.png" },
